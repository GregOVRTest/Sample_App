...
describe User do
  ...
  before(:each) do
    @attr = { :name => "Example User", :email => "user@example.com" , :password => "Example", :password_confirmation => "Example" }
  end
  ...
  describe "password validations" do
    ...
    it "should reject short passwords" do
      ...
      User.new(short_password).should_not be_valid
    end
    it "should reject long passwords" do
      long = "a" * 41
      long_password = @attr.merge(:password => long, :password_confirmation =>long)
      User.new(long_password).should_not be_valid
    end
  end
